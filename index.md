...
<body>
  <div class="container">
    ...
    <section>
      ...
      <ul>
        <li>
          <a href="https://medium.com/@psagarna/c%C3%B3mo-agregar-un-evento-ante-un-cambio-de-estado-de-una-api-en-su-ciclo-de-vida-7c9cac3798ef" target="_blank">¿Cómo agregar un evento ante un cambio de estado de una API en su ciclo de vida?</a>.<strong> Pablo Sagarna - 2025.</strong> 
        </li>
      </ul>
    </section>
  </div>
